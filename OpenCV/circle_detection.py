...
src = cv2.imread("OpenCV/images/yejin.png")
dst = src.copy()
gray = cv2.cvtColor(src, cv2.COLOR_BGR2GRAY)

circles = cv2.HoughCircles(gray, cv2.HOUGH_GRADIENT, 1, 100, param1 = 50, param2 = 50, minRadius = 1, maxRadius = 120)

for i in circles[0]:
    cv2.circle(dst, (int(i[0]), int(i[1])), int(i[2]), (120, 120, 120), 5)
...
# # 원본 이미지 불러오기
# image = cv2.imread("OpenCV/images/circle/circle7.png", 1)
