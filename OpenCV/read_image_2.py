import cv2
from read_image_1 import print_matInfo      # 행렬 정보 출력 함수 임포트

title1, title2 = 'color2gray', 'color2color'
color2gray = cv2.imread('OpenCV/images/read_color.jpg', cv2.IMREAD_GRAYSCALE)
color2color = cv2.imread('OpenCV/images/read_gray.jpg', cv2.IMREAD_COLOR)
